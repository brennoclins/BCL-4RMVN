    ...
    >
      ...
      <div className="p-8 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className={`h-1 w-12 my-3 mx-auto md:mx-0 rounded-full ${isOrange ? 'bg-[#ff6600]' : 'bg-[#00ff44]'}`}></div>
        ...
        <div className="flex flex-col items-center gap-4 shrink-0">
          <div className="flex items-center gap-2 bg-black/5 px-3 py-1 rounded border border-black/5">
            <div className={`w-2 h-2 rounded-full ${isOrange ? 'bg-[#ff6600] animate-pulse shadow-[0_0_8px_#ff6600]' : 'bg-[#00ff44] shadow-[0_0_8px_#00ff44]'}`}></div>
            <span className="text-[10px] font-mono font-bold text-[#202020]">READY</span>
          </div>
          <svg className={`w-6 h-6 text-[#505050] group-hover:translate-x-2 transition-transform ${isOrange ? 'group-hover:text-[#ff6600]' : 'group-hover:text-[#00ff44]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
